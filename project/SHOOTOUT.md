...
- `.github/workflows/shootout-godot.yml` → `kidslive-godot-benchmark-apk`
- `.github/workflows/shootout-skia.yml` → `kidslive-skia-benchmark-apk`

The Phaser candidate continues to deploy from `main` to Cloudflare Pages.
